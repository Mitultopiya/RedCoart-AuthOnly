  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO invoices (
        ...
        package_name, hotel_category, vehicle_type
      ...
      [
        ...
        package_name || null, hotel_category || null, vehicle_type || null,
      ]
    );
  ...
  try {
    ...
    await pool.query(
      `UPDATE invoices SET
        ...
        package_name=$20, hotel_category=$21, vehicle_type=$22, updated_at=NOW()
       WHERE id=$23`,
      [
        ...
        package_name || null, hotel_category || null, vehicle_type || null, id,
      ]
    );
    if (items) {
